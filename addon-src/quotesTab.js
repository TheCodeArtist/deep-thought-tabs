var quotes = [
	...
	'If you define cowardice as running away at the first sign of danger,<br>screaming, tripping, and begging for mercy,<br>then yes, Mr. Brave man,<br>I guess I\'m a coward.',
	...
	'You know what would make a good story? Something about a clown who made people happy,<br>but inside he\'s really sad.<br><br>Also,<br>he has severe diarrhea.',
	'Sometimes when I feel like killing someone,<br>I do a little trick to calm myself down.<br><br>I\'ll go over to the person\'s house and ring the doorbell.<br><br>When the person comes to the door,<br>I\'m gone,<br>but you know what I\'ve left on the porch? A jack-o-lantern with a knife stuck in the side of its head with a note that says "You." After that I usually feel a lot better,<br>and no harm done.',
	...
	'Anytime I see something screech across a room and latch onto someone\'s neck,<br>and the guy screams and tries to get it off,<br>I have to laugh,<br>because what is that thing.',
	...
	'When the age of the Vikings came to an end,<br>they must have sensed it.<br><br>Probably,<br>the gathered together one evening,<br>slapped each other on the back and said,<br>"Hey,<br>good job."',
	...
	'I bet for an Indian,<br>shooting an old fat pioneer woman in the back with an arrow,<br>and she fires her shotgun into the ground as she falls over,<br>is like the top thing you can do.',
	...
	'If I live in the Wild West days,<br>instead of carrying a six-gun in my holster,<br>I\'d carry a soldering iron.<br><br>That was if some smart-aleck cowboy said something like,<br>"Hey look.<br><br>He\'s carrying a soldering iron!" and started laughing,<br>and everybody else started laughing,<br>I could just say,<br>"That\'s right,<br>it\'s a soldering iron.<br><br>The soldering iron of justice." Then everyone would get really quiet and ashamed,<br>because they made fun of the soldering iron of justice,<br>and I could probably hit them up for a free drink.',
